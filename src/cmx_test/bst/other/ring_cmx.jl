...
#=x = range(1, 57)
plot(x, [energies_fci energies_pt2 energies_cmx],title="Energy of H8_ring ", label=[ "fci energies" "pt2 corrected energy" "cmx energies"], linewidth=2)
savefig("plot_ring3.png")=#